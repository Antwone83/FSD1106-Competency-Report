    ...
    $.ajax({
        ...
        success: function (dataString) {
            ...
            for (let i = 0; i < allTasks.length; i++) {
                ...
                //  print the task, only if the task is equal to your name
                if (task.name === "Antwone") {
                    displayTask(task);
...
function saveTask() {
    ...
    let theTask = new Task(important, title, desc, dueDate, status, category, color, name);
